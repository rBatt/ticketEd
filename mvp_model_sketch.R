...
# AIC = 49790.03
# cor(egDat[,counts], fitted(mod1)) # 0.434887
...
# AIC = 35193
# cor(tsVec, fitted(mod3)) # 0.3508718
...
# AIC = 30693
# cor(tsVec, fitted(mod4)) # 0.7408245
...
# AIC = 36694
# cor(tsVec, fitted(mod5)) # 0.2899756
...
# AIC = 29112
# cor(tsVec, fitted(mod6)) # 0.4520971
