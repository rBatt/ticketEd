...
def createPrecinctLookup(dir):
    ...
    try:
        ...
        print
        'Error opening ' + dir + 'precinct.csv', sys.exc_info()[0]
...
def createStreetLookup(dir):
    ...
    try:
        ...
        print
        'Error opening ' + dir + 'streetcode.csv', sys.exc_info()[0]
...
def createBoroAbbrvLookup(dir):
    ...
    try:
        ...
        print
        'Error opening ' + dir + 'boroabbrv.csv', sys.exc_info()[0]
...
def createStreetReplace(dir):
    ...
    try:
        ...
        print
        'Error opening ' + dir + 'streetreplace.csv', sys.exc_info()[0]
...
def createSkipId(dir):
    ...
    try:
        ...
        print
        'Error opening ' + dir + 'goodids.csv .' + str(i), sys.exc_info()[0]
    ...
    for row in reader:
        ...
        if (
            ...
            if (retCode == "00"):
                ...
                r.summonsnumber, housenumber, r.streetname, r.intersectingstreet, street1, street2, street3,
                data["intersection"]["latitude"], data["intersection"]["longitude"],
                data["intersection"]["policePrecinct"], data["intersection"]["geosupportReturnCode"], "")
                ...
                ret = '%s,%s,%s,%s,%s,%s,%s,%f,%f,%s,%s,%s\n' % (
                r.summonsnumber, housenumber, r.streetname, r.intersectingstreet, street1, street2, street3, 0.0, 0.0,
                "00", data["intersection"]["geosupportReturnCode"], data["intersection"]["message"].replace(',', ' '))
            ...
            if (retCode == "00"):
                ...
                data["address"]["geosupportReturnCode"], "")
                # str= objid+","+data["intersection"]["latitude"]+","+data["intersection"]["longitude"]+","+data["intersection"]["policePrecionct"]+","+data["intersection"]["geosupportReturnCode"]
            elif (retCode == "01"):
                ret = '%s,%s,%s,%s,%s,%s,%s,%f,%f,%s,%s,%s\n' % (
                r.summonsnumber, housenumber, r.streetname, r.intersectingstreet, street1, street2, street3,
                ...
                if (retCode == "00"):
                    ...
                    if (retCode == "00"):
                        ...
                        ret = '%s,%s,%s,%s,%s,%s,%s,%f,%f,%s,%s,%s\n' % (
                        r.summonsnumber, housenumber, r.streetname, r.intersectingstreet, street1, street2, street3,
                        0.0, 0.0, "00", data["intersection"]["geosupportReturnCode"],
                        data["intersection"]["message"].replace(',', ' '))
